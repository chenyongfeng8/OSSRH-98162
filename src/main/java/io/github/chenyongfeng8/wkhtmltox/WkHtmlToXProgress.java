package io.github.chenyongfeng8.wkhtmltox;

public class WkHtmlToXProgress {
    private final int phase;
    private final String phaseDescription;
    private final int totalPhases;
    private final int phaseProgress;

    public WkHtmlToXProgress(int phase, String phaseDescription, int totalPhases, int phaseProgress) {
        this.phase = phase;
